 ...
 * Class: WallFollower
 * 
 * Responsibilities: to drive through the maze one move at a time following the wall to its right until it either 
 * reaches the exit position or runs out of battery. It is supposed to show the movements one at a time. The speed can be changed
 * by raising or lower the number in the thread.sleep() statements.
 * 
 * Collaborators: Robot, BasicRobot, RobotDriver, CardinalDirection, MazeController
 * 
 * @author corythomas
 *
 */
