...
public class Cells {
	...
	/**
	 * does the same thing as the previous canGo method except we do not care if
	 * we have visited the wall before with Kruskal's like with Prim's algorithm
	 */
//	public boolean canGoKruskal(Wall wall) {
//		int x = wall.getX();
//		int y = wall.getY();
//		int[] d = wall.getDirection().getDirection() ;
//		int dx = d[0];
